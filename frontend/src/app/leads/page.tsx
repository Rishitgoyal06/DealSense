        ...
        <div className="bg-base-100 shadow-xl overflow-hidden rounded-2xl border border-base-300">
          {leads.length === 0 ? (
            <div className="text-center py-16">
              ...
              <h3 className="text-xl font-semibold text-base-content mb-2">No leads yet</h3>
              <p className="text-base-content/70 mb-6">Get started by creating your first lead.</p>
              <Link
                href="/leads/new"
            ...
            <ul className="divide-y divide-base-300">
              {leads.map((lead) => (
                <li key={lead._id} className="px-8 py-6 hover:bg-base-200 transition-all duration-200">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <h3 className="text-xl font-semibold text-base-content">{lead.name}</h3>
                      ...
                      <p className="text-base-content/70 mb-1 flex items-center">
                      ...
                      <p className="text-base-content/60 mb-2">{lead.requirement}</p>
                    ...
                    <div className="text-right ml-6">
                      ...
                      <div className="flex items-center justify-end space-x-2 mb-2">
                        <div className="flex items-center">
                          ...
                          <span className="text-sm font-medium text-base-content">{lead.readinessScore}/100</span>
                        </div>
                      </div>
